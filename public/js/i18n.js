...
export const translations = {
  pt: {
    ...
    videoSection: {
      ...
      subtitle: "Demonstração prática dos recursos do SoundWorld Kids",
      placeholderBadge: "Vídeo Demonstrativo",
      placeholderDesc: "Explore os 16 bichinhos, jogos sonoros, teclado e modo noturno em uma experiência interativa."
    },
    ...
    whyFamiliesChoose: {
      ...
      item2: "Controle de volume seguro com limite personalizável em porcentagem",
    ...
    trial: {
      badgeTrial: "⏱️ Teste Gratuito",
      badgeUnlocked: "🌟 Acesso Vitalício",
      ...
      kiwifyBenefit2: "16 bichinhos reais para explorar",
      ...
      kiwifySecure: "🔒 Pagamento Seguro via Kiwify • PIX e Cartão • Liberação Imediata",
      ...
      licenseBadge: "Licença Vitalícia",
      priceTag: "R$ 19,90",
      pixCopyTitle: "Ou pague via PIX direto:",
      pixCopyBtn: "Copiar Chave PIX (E-mail)",
      pixValidateBtn: "Validar Código",
      codePlaceholder: "Código de Ativação",
      supportWhatsapp: "Dúvidas? Fale com nosso suporte no WhatsApp"
    },
    ...
    parentGate: {
      ...
      challengeTitle: "Acesso Restrito aos Responsáveis",
      challengePrompt: "Resolva a conta para entrar:",
      challengeSubmit: "Entrar",
      challengeError: "Resultado incorreto. Tente novamente.",
      dailyUsage: "Tempo de uso hoje:",
      minutes: "minutos",
      orderLabel: "ID do Pedido:",
      licenseLabel: "Status da Licença:",
      licenseTrial: "Degustação Gratuita (60 min)",
      licenseVip: "Vitalício Ativado 🌟",

      settings: {
        title: "Configurações da Experiência",
        volumeLimiter: "Controle de volume",
        volumeDescription: "Os responsáveis podem limitar o volume máximo para uma experiência mais confortável.",
        safeLevel: "Nota técnica: trava acústica no sintetizador (≤ 85 dB)",
        languageSelect: "Idioma Principal",
        screenTimeLimit: "Limite de Tempo de Tela",
        screenTimeDescription: "Defina uma pausa automática para proteger o bem-estar visual.",
        timerOff: "Sem limite",
        timer15: "15 minutos",
        timer30: "30 minutos",
        timer45: "45 minutos",
        timerActive: "Tempo restante de tela: "
      },

      patronage: {
        title: "Licença Vitalícia SoundWorld 🌟",
        description: "Adquira o acesso vitalício completo por apenas R$ 19,90 (pagamento único via Kiwify ou PIX). Experiência infantil desenvolvida com foco em segurança, privacidade e uso supervisionado por pais ou responsáveis, sem anúncios e com acesso ilimitado a todos os sons disponíveis.",
        copyPix: "Copiar Código PIX Copia-e-Cola (R$ 19,90)",
  ...
  en: {
    ...
    videoSection: {
      ...
      subtitle: "Hands-on preview of SoundWorld Kids features",
      placeholderBadge: "Preview Video",
      placeholderDesc: "Explore the 16 animals, sound games, keyboard, and bedtime mode in an interactive experience."
    },
    ...
    whyFamiliesChoose: {
      ...
      item2: "Safe volume control with customizable percentage limit",
    ...
    trial: {
      badgeTrial: "⏱️ Free Trial",
      badgeUnlocked: "🌟 Lifetime Access",
      ...
      kiwifyBenefit2: "16 real animals to explore",
      ...
      kiwifySecure: "🔒 Secure Checkout via Kiwify • Instant Access",
      ...
      licenseBadge: "Lifetime License",
      priceTag: "R$ 19.90",
      pixCopyTitle: "Or pay via direct PIX:",
      pixCopyBtn: "Copy PIX Key (E-mail)",
      pixValidateBtn: "Validate Code",
      codePlaceholder: "Activation Code",
      supportWhatsapp: "Questions? Chat with our support on WhatsApp"
    },

    // Parent Gate
    parentGate: {
      title: "Parents Area",
      subtitle: "Hearing safety settings, volume, and screen time",
      challengeTitle: "Restricted Access for Caregivers",
      challengePrompt: "Solve the sum to enter:",
      challengeSubmit: "Enter",
      challengeError: "Incorrect result. Please try again.",
      dailyUsage: "Playtime today:",
      minutes: "minutes",
      orderLabel: "Order ID:",
      licenseLabel: "License Status:",
      licenseTrial: "Free Trial (60 min)",
      licenseVip: "Lifetime Activated 🌟",

      settings: {
        title: "Experience Settings",
        volumeLimiter: "Volume control",
        volumeDescription: "Caregivers can limit the maximum volume for a more comfortable experience.",
        safeLevel: "Technical note: acoustic synthesizer limit (≤ 85 dB)",
        languageSelect: "Main Language",
        screenTimeLimit: "Screen Time Limit",
        screenTimeDescription: "Set an automatic pause to encourage healthy screen breaks.",
        timerOff: "No limit",
        timer15: "15 minutes",
        timer30: "30 minutes",
        timer45: "45 minutes",
        timerActive: "Remaining screen time: "
      },

      patronage: {
        title: "SoundWorld Lifetime License 🌟",
        description: "Unlock full lifetime access for just R$ 19.90 (one-time payment via Kiwify or PIX). Childhood experience developed with a focus on safety, privacy, and parental supervision, zero ads, and unlimited access to all available sounds.",
